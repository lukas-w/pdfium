...
class CheckChangeOnUploadTest(unittest.TestCase):
  ...
  def testCheckPngNames(self):
    correct_paths = [
        ...
        'test_expected_skia_gdi.pdf.10.png',
    ...
    wrong_paths = [
        ...
        'test4_expected_win_agg.pdf.0.png',  # Wrong order of keywords
        'test4_expected_linux_agg.pdf.0.png',  # Wrong order of keywords
        'test4_expected_mac_skia.pdf.0.png',  # Wrong order of keywords
        'test4_expected_gdi_skia.pdf.0.png',  # Wrong order of keywords
        'test4_expected_gdi_agg.pdf.3.png',  # Wrong order of keywords
        ...
        'test8_expected_gdi_agg_win.pdf.4.png',  # Too many suffixes
        'test9_expected_gdi_skia_linux.pdf.5.png',  # Too many suffixes
        'test10_expected_gdi_mac.pdf.0.png',  # Too many platforms
    ]
