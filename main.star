...
add_entries_for_builder(name = "linux_xfa_rust", category = "xfa|linux", short_name = "rust", swarm_tests = True)
...
add_entries_for_builder(name = "mac_xfa_rust", category = "xfa|mac", short_name = "rust")
...
add_entries_for_builder(name = "win_xfa_rust", category = "xfa|win", short_name = "rust")
